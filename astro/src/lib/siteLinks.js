...
export const linkDocs = siteConfig.DOCS_URL;
export const linkReleaseNotes = siteConfig.RELEASE_NOTES_URL;
...
export const linkSupport = siteConfig.SUPPORT_URL;
export const linkGitHub = siteConfig.GITHUB_URL;
export const linkRegionDocs = siteConfig.REGION_DOCS_URL;
